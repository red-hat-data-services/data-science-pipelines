...
To modify the pipelines for `data-science-pipelines` in the `rhoai-3.6-ea.1` release:
...
```bash
git commit -am "Update pipelinerun for data-science-pipelines (rhoai-3.6-ea.1)"

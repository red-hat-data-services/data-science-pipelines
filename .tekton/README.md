...
To modify the pipelines for `data-science-pipelines` in the `rhoai-2.23-multi-arch-poc` release:
...
```bash
git commit -am "Update pipelinerun for data-science-pipelines (rhoai-2.23-multi-arch-poc)"

...
func TestCreatePipelineV1_LargeFile(t *testing.T) {
	...
	pipeline, err := pipelineServer.CreatePipelineV1(context.Background(), &api.CreatePipelineRequest{
		Pipeline: &api.Pipeline{
			Url:         &api.Url{PipelineUrl: "https://raw.githubusercontent.com/red-hat-data-services/data-science-pipelines/rhoai-2.19/sdk/python/test_data/pipelines/xgboost_sample_pipeline.yaml"},
			Name:        "xgboost-url",
			Description: "pipeline description",
		},
	})
	...
	tests := []struct {
		...
		},
		{
			...
			&apiv2.CreatePipelineAndVersionRequest{
				...
				PipelineVersion: &apiv2.PipelineVersion{
					PackageUrl: &apiv2.Url{
						PipelineUrl: "https://raw.githubusercontent.com/red-hat-data-services/data-science-pipelines/rhoai-2.19/sdk/python/test_data/pipelines/xgboost_sample_pipeline.yaml",
					},
				},
			},
			&apiv2.Pipeline{

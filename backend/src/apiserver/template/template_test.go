...
func TestNewArgoTemplate_Valid(t *testing.T) {
	tmpl, err := NewArgoTemplate([]byte(template))
	assert.Nil(t, err)
...
func TestArgo_Bytes(t *testing.T) {
	tmpl, _ := NewArgoTemplate([]byte(template))
	result := tmpl.Bytes()
...
func TestV2Spec_GetTemplateType(t *testing.T) {
	template := loadYaml(t, "testdata/hello_world.yaml")
	tmpl, err := NewV2SpecTemplate([]byte(template), false)
	assert.Nil(t, err)
...
func TestV2Spec_IsV2(t *testing.T) {
	template := loadYaml(t, "testdata/hello_world.yaml")
	tmpl, _ := NewV2SpecTemplate([]byte(template), false)
...
func TestV2Spec_IsCacheDisabled(t *testing.T) {
	template := loadYaml(t, "testdata/hello_world.yaml")
	tmplEnabled, _ := NewV2SpecTemplate([]byte(template), false)
	assert.False(t, tmplEnabled.IsCacheDisabled())

	tmplDisabled, _ := NewV2SpecTemplate([]byte(template), true)
...
func TestNewV2SpecTemplate_EmptyInput(t *testing.T) {
	_, err := NewV2SpecTemplate([]byte(""), false)
	assert.NotNil(t, err)
...
func TestNew_UnknownFormat(t *testing.T) {
	_, err := New([]byte("not a valid template"), false)
	assert.NotNil(t, err)

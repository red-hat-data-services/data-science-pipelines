...
func (s *PipelineApiTest) TestPipelineAPI() {
	...
	assert.Equal(t, "https://raw.githubusercontent.com/red-hat-data-services/data-science-pipelines/refs/heads/rhoai-2.21/backend/test/v2/resources/sequential.yaml", sequentialPipelineVersions[0].PackageURL.PipelineURL)
	...
	argumentUrlPipelineVersion, err := s.pipelineClient.CreatePipelineVersion(
		&params.PipelineServiceCreatePipelineVersionParams{
			...
			Body: &model.V2beta1PipelineVersion{
				...
				PackageURL: &model.V2beta1URL{
					PipelineURL: "https://github.com/red-hat-data-services/data-science-pipelines/raw/refs/heads/rhoai-2.21/backend/test/v2/resources/arguments.pipeline.zip",
				},
			},
		})
	require.Nil(t, err)
	...
	assert.Equal(t, "https://github.com/red-hat-data-services/data-science-pipelines/raw/refs/heads/rhoai-2.21/backend/test/v2/resources/arguments.pipeline.zip", argumentUrlPipelineVersion.PackageURL.PipelineURL)

...
func (s *PipelineApiTest) TestPipelineAPI() {
	...
	assert.Equal(t, "https://raw.githubusercontent.com/red-hat-data-services/data-science-pipelines/refs/heads/rhoai-2.19/backend/test/v2/resources/sequential.yaml", sequentialPipelineVersions[0].PackageURL.PipelineURL)
	...
	assert.Equal(t, "https://github.com/red-hat-data-services/data-science-pipelines/raw/refs/heads/rhoai-2.19/backend/test/v2/resources/arguments.pipeline.zip", argumentUrlPipelineVersion.PackageURL.PipelineURL)
